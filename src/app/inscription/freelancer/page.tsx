...
// TODO: placeholder. Step 2 — the role-branded "Freelance" signup form — replaces
// this in the next sprint.
export default async function FreelancerStep2Placeholder() {
  const lang = await getLang()
  const role = t('signup.intent.cards.freelancer.label', lang)
