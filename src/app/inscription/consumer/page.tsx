...
// TODO: placeholder. Step 2 — the role-branded "Acheter" signup form — replaces
// this in the next sprint.
export default async function ConsumerStep2Placeholder() {
  const lang = await getLang()
  const role = t('signup.intent.cards.consumer.label', lang)
