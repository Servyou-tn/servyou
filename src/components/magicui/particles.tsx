...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  /* eslint-disable react-hooks/refs -- vendored Magic UI: latest-closure ref
     pattern; these are written during render by design and read only inside
     effects / rAF, which is safe. */
