...
// Textarea — measured from Figma COMPONENT_SET 86:2299 (the Input primitive's sibling). Promoted
// to components/ui on its second real consumer (PR-D, /mes-annonces/nouvelle) — E1 was first.
//
