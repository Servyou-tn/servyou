...
// Dark "expanded" sidebar — a floating navy card (brand-blue-800). The active item
...
export function DashboardSidebar({
  ...
  return (
    <div className="flex h-full w-full flex-col rounded-2xl bg-brand-blue-800 p-5 text-white">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${FOCUS_RING} ${
                active ? 'bg-white text-brand-blue-800' : 'text-white/70 hover:bg-white/5 hover:text-white'
              }`}
            >
