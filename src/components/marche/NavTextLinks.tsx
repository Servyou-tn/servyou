...
// pills. Plain navigation links with an animated brand-accent underline: the active link carries a
// static 80%-width underline + brand-accent text; inactive links slide the underline in left-to-
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              'after:absolute after:inset-x-[10%] after:bottom-0 after:h-0.5 after:rounded-full after:bg-brand-accent after:origin-left after:transition-transform after:duration-200 after:ease-out motion-reduce:after:transition-none',
              isActive
                ? 'text-brand-accent after:scale-x-100'
                : 'text-text-primary after:scale-x-0 hover:text-brand-accent hover:after:scale-x-100',
            )}
          >
            {o.label}
          </Link>
