...
- **Definition of Done (11):** (1) discovery approved before code; (2) scope matches, no opportunistic refactors; (3) `pnpm build` green locally; (4) test suite passes; (5) tests added for must-test code; (6) diff read against scope; (7) PR body = What ships / Changes / Decisions / Out-of-scope / Verification / Followups; (8) agent report made; (9) Vercel green; (10) manual click-through (sanity check for mechanical refactors); (11) founder approves merge.
